                    ...
                    <div className="reveal">
                        ...
                        <div className="flex items-center justify-between w-full">
                            ...
                            <div className="flex justify-center lg:justify-end">
                                <div class="relative h-28 w-28 shrink-0 overflow-hidden rounded-full ring-2 ring-blue-500/30 ring-offset-2 ring-offset-black sm:h-32 sm:w-32 md:h-36 md:w-36"
                                        data-aos="fade-up"
                                >
                                    <img src={avatar} alt="" />
                                </div>
                            ...
                            <div class="flex lg:ml-auto items-center gap-2 md:gap-3 lg:border-l lg:border-white/10 lg:pl-8">
                                ...
                                >
                                    <svg
                                        ...
                                        class="tabler-icon tabler-icon-brand-github h-5 w-5 md:h-6 md:w-6 text-white"
                                    >
                                ...
                                >
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="tabler-icon tabler-icon-brand-linkedin h-5 w-5 md:h-6 md:w-6 text-white"
                                    >
                                        <path d="M8 11v5"></path>
                                ...
                                >
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="tabler-icon tabler-icon-mail h-5 w-5 md:h-6 md:w-6 text-white"
                                    >
                                ...
                                >
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="lucide lucide-file-text h-5 w-5 text-white group-hover:text-white transition-colors"
                                        aria-hidden="true"
                                    >
