...
function ProfileSection() {
    return (
        <div className="reveal grid gap-8 md:grid-cols-[240px_1fr] lg:grid-cols-[300px_1fr]">
            ...
            <div className="space-y-6">
                <div>
                    <h2
                        ...
                        data-aos-delay={100}
                    >
                        Hey! I'm <span className="text-blue-400 font-semibold">Darben Lamonte</span>
                    </h2>
                    <p
                        className="mt-2 text-lg text-blue-400"
                        data-aos="fade-up"
                        data-aos-delay={100}
                    >
