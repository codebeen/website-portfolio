...
function AllProjects() {
    ...
    }, [currentPage, searchQuery, techFilter]);
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-4">
                    ...
                    <div className="relative w-full sm:w-1/4">
                        ...
                        >
                            ...
                            <option className="bg-gray-900" value="asp.net">
                                ASP.NET
                            </option>
                            <option className="bg-gray-900" value="csharp">
                                C#
                            </option>
                            <option className="bg-gray-900" value="django">
                                Django
                            </option>
                            <option className="bg-gray-900" value="javascript">
                                JavaScript
                            </option>
                            <option className="bg-gray-900" value="laravel">
                                Laravel
                            </option>
                            <option className="bg-gray-900" value="mssql">
                                MS SQL
                            </option>
                            <option className="bg-gray-900" value="mysql">
                                MySQL
                            </option>
                            <option className="bg-gray-900" value="python">
                                Python
                            </option>
                            <option className="bg-gray-900" value="react">
                                React
                            </option>
                        </select>
                        <svg
